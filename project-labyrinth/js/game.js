...
gameMessages.innerHTML = "Use the arrow keys to escape the <strong>MAZE OF DEATH</strong> <em>Mwahahahaahaaa...</em><br><br>You are blue, get to green.";
...
function keyboardHandler(event)
{
	...
	if(playerCell == nRows*nCols-1)
	{
		...
		gameMessages.innerHTML = "Conga ratz, you made it out this time...<br>It took you " + nSteps + " steps of which " + nBacktrack + " were feeble and confused backtracking.";
	}
}
...
function render()
{
	...
	for(var cell = 0; cell < nRows*nCols; cell++)
	{
		...
		if(cell == playerCell)
			drawingSurface.fillStyle = "rgba(0, 0, 255, 0.4)";
